...
void MyCamera::MoveForward(float a_fDistance)
{
	...
	m_v3Forward = glm::normalize(vector3(m_v3Position.x - m_v3Target.x, m_v3Position.y - m_v3Target.y, m_v3Position.z - m_v3Target.z));
	
	// Moving the camera based on the forward vector
...
void MyCamera::MoveVertical(float a_fDistance)
{
	...
	float angle = PI / 2.0f;
	m_v3Up = glm::rotateX(glm::normalize(vector3(m_v3Position.x - m_v3Target.x, m_v3Position.y - m_v3Target.y, m_v3Position.z - m_v3Target.z)),angle);
	
	// Moving the camera based on the up vector
...
void MyCamera::MoveSideways(float a_fDistance)
{
	...
	float angle = PI / 2.0f;
	m_v3Right = glm::rotateY(glm::normalize(vector3(m_v3Position.x - m_v3Target.x, m_v3Position.y - m_v3Target.y, m_v3Position.z - m_v3Target.z)), angle);

	// Moving the camera based on the right vector
