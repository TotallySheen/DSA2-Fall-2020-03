...
class MyCamera
{
	...
	vector3 m_v3Forward = vector3(0.0f, 0.0f, 1.0f); // Forward Vector
	vector3 m_v3Right = vector3(1.0f, 0.0f, 0.0f); // Right Vector
	vector3 m_v3Up = vector3(0.0f, 1.0f, 0.0f); // Up vector
